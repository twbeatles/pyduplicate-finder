...
def build_translations() -> dict[str, dict[str, str]]:
    return {
                "en": {
                    ...
                    "btn_save_operation_plan": "Save Plan",
                    "btn_load_operation_plan": "Load Plan",
                    ...
                    "err_similar_image_dependency": "Similar image scan requires imagehash and Pillow (pip install imagehash Pillow)",
                    ...
                    "settings_density_label": "UI density",
                    "opt_density_comfortable": "Comfortable",
                    "opt_density_compact": "Compact",
                    "tip_density": "Adjust button and list spacing.",
                    "settings_follow_system": "Follow system theme",
                    ...
                    "term_folder_group": "Folder Group",
                    "term_daily": "Daily",
                    "term_weekly": "Weekly",
                    "term_weekday_mon": "Mon",
                    "term_weekday_tue": "Tue",
                    "term_weekday_wed": "Wed",
                    "term_weekday_thu": "Thu",
                    "term_weekday_fri": "Fri",
                    "term_weekday_sat": "Sat",
                    "term_weekday_sun": "Sun",
                    ...
                    "chk_similar_document": "Find Similar Documents (SimHash)",
                    "chk_name_only": "Filename only (ignore content)",
                    "chk_apply_exemptions": "Respect Safelist / Ignore Rules",
                    "chk_post_cleanup_empty_dirs": "Cleanup Empty Folders After Delete",
                    "chk_watch_mode": "Watch Mode",
                    ...
                    "msg_operation_plan_saved": "Operation plan saved: {path}",
                    "msg_operation_plan_loaded": "Plan loaded: {loaded} selected, {skipped} skipped",
                    ...
                    "msg_delete_dry_run_title": "Delete Simulation (Dry-run)",
                    "msg_delete_dry_run_summary": "Selected: {total} (Visible: {visible})\nEstimated reclaim: {size}",
                    "msg_delete_dry_run_group_line": "{idx}. {count} selected • {size} • {name}",
                    "msg_delete_dry_run_more": "... and {count} more groups",
                    "msg_risk_summary": "Risk groups: high {high} / medium {medium} / low {low}",
                    ...
                    "msg_insights_page_hint": "Scan history, savings, failure rate, and scheduled runs at a glance.",
                    ...
                    "lbl_document_similarity_threshold": "Document Threshold:",
                    "lbl_selection_policy": "Selection Policy:",
                    "lbl_compare_mode": "Compare Mode:",
                    "tip_similar_image": "Finds visually similar images even if resized or recompressed",
                    "tip_similar_document": "Groups near-duplicate text and PDF documents using SimHash",
                    ...
                    "tip_apply_exemptions": "Skip ignored paths and keep safelisted files during scan and auto-selection",
                    "tip_post_cleanup_empty_dirs": "After delete or hardlink actions, remove newly empty parent folders",
                    "tip_watch_mode": "Keep monitoring selected folders and trigger incremental rescans on file changes",
                    "opt_policy_smart": "Smart",
                    "opt_policy_oldest": "Keep Oldest",
                    "opt_policy_newest": "Keep Newest",
                    "opt_policy_path_shortest": "Shortest Path",
                    "opt_policy_extension_priority": "Extension Priority",
                    "opt_policy_primary_keep": "Primary Collection First",
                    "opt_compare_none": "Normal Scan",
                    "opt_compare_collections": "Compare Collections",
                    ...
                    "hdr_filters_strategy": "Scan Strategy",
                    "msg_scan_stage": "Stage: {stage}",
                    "lbl_baseline_session": "Baseline session:",
                    "msg_incremental_no_baseline": "No compatible completed baseline session found. Incremental mode will be disabled.",
                    "msg_incremental_delta": "Incremental delta: +{added} new, {changed} changed, -{missing} missing",
                    ...
                    "badge_similar_document": "Similar document",
                    "badge_byte_compare": "Byte-compare",
                    "badge_folder_dup": "Folder duplicate",
                    "badge_risk_low": "Risk low",
                    "badge_risk_medium": "Risk medium",
                    "badge_risk_high": "Risk high",
                    ...
                    "label_similar_document_group": "Similar document #{id}",
                    ...
                    "col_created": "Created",
                    "col_status": "Status",
                    "tool_exemptions_title": "Safelist / Ignore",
                    "tool_exemptions_desc": "Manage scan exemptions. Ignored paths are skipped; safelisted files are kept during auto-selection.",
                    ...
                    "col_groups": "Groups",
                    "col_files": "Files",
                    "col_missing_folders": "Missing Folders",
                    "col_export_failed": "Export Failed",
                    "col_watch_events": "Watch Events",
                    "col_job_name": "Job",
                    ...
                    "msg_retry_unavailable": "Retry data is unavailable for this operation.",
                    ...
                    "op_undo_done": "Undo restored {ok}",
                    "op_undo_partial": "Undo restored {ok} (failed {failed})",
                    "op_redo_done": "Redo deleted {ok}",
                    "op_redo_partial": "Redo deleted {ok} (failed {failed})",
                    "op_trash_move_failed": "Failed to move files to system trash",
                    "op_trash_move_partial": "Moved {ok}/{total} to trash (failed {failed})",
                    "op_trash_move_done": "Moved {ok} to trash",
                    "op_insufficient_space": "Insufficient disk space. Required: {required:.1f}MB, Available: {available:.1f}MB",
                    "op_delete_partial": "Deleted {ok}/{total} files (failed {failed})",
                    "op_delete_done": "Deleted {ok} files",
                    "op_no_files_deleted": "No files were deleted",
                    "qm_item_not_found": "Item not found",
                    "qm_item_not_quarantined": "Item is not quarantined",
                    "qm_quarantine_file_missing": "Quarantine file missing",
                    "qm_restored": "restored",
                    "qm_purged": "purged",
                    ...
                    "ctx_review_keep": "Mark Reviewed Keep",
                    "ctx_review_delete_later": "Mark Delete Later",
                    "ctx_review_clear": "Clear Review Mark",
                    "ctx_group_review_keep": "Mark Group Reviewed Keep",
                    "ctx_group_review_delete_later": "Mark Group Delete Later",
                    "ctx_group_review_clear": "Clear Group Review Marks",
                    ...
                    "settings_schedule_title": "Scheduled Scan",
                    "settings_schedule_enabled": "Enable scheduled scan",
                    "settings_schedule_frequency": "Frequency:",
                    "settings_schedule_time": "Time (HH:MM):",
                    "settings_schedule_weekday": "Weekday:",
                    "settings_schedule_output": "Output folder:",
                    "settings_schedule_job_name": "Job name:",
                    "settings_schedule_export_json": "Export JSON",
                    "settings_schedule_export_csv": "Export CSV",
                    "settings_schedule_runs": "Recent runs",
                    "ph_schedule_job_name": "e.g. nightly_photos",
                    "btn_schedule_new": "New Job",
                    "btn_schedule_run_now": "Run Now",

                    "btn_session_compare": "Compare Sessions",
                    "btn_select_in_results": "Select in Results",
                    "opt_delta_all": "All changes",
                    "opt_delta_new": "New",
                    "opt_delta_changed": "Changed",
                    "opt_delta_revalidated": "Revalidated",
                    "dlg_session_compare_title": "Session Compare",
                    "msg_session_compare_summary": "Current session #{current} vs baseline #{baseline}\nNew: {new} • Changed: {changed} • Revalidated: {revalidated}",
                    "msg_session_compare_empty": "No baseline delta data is available for this result set.",

                    "insight_scans_title": "Scans",
                    "insight_scans_hint": "Completed scans / total recorded sessions",
                    "insight_savings_title": "Saved Space",
                    "insight_savings_hint": "Estimated bytes reclaimed from file operations",
                    "insight_fail_rate_title": "Failure Rate",
                    "insight_fail_rate_hint": "Partial/failed sessions in the most recent 20 runs",
                    "insight_quarantine_title": "Quarantine",
                    "insight_quarantine_hint": "Items and total size currently kept for undo",
                    "insight_sessions_title": "Recent Sessions",
                    "insight_jobs_title": "Scheduled Run History",

                    "msg_empty_cleanup_done": "Removed {count} newly empty folders.",
                    "msg_watch_armed": "Watch mode armed.",
                    "msg_watch_armed_polling": "Watch mode armed (polling fallback).",
                    "msg_watch_pending_rerun": "Filesystem changes detected. A rerun is queued after the current scan.",
                    ...
                    "ex_kind_exact_path": "Exact path",
                    "ex_kind_path_glob": "Path glob",
                    "ex_kind_content_hash": "Content hash",
                    "ex_action_safelist": "Safelist",
                    "ex_action_ignore": "Ignore",
                    "ph_exemption_value": "Path, glob, or BLAKE2b hash...",
                    "ph_exemption_note": "Note...",
                    "ph_exemption_search": "Search rules...",
                    "opt_status_all": "All statuses",
                    "opt_status_quarantined": "Quarantined",
                    "opt_status_restored": "Restored",
                    "opt_status_purged": "Purged",
                    "ph_min_size_bytes": "Min bytes",
                    "ph_max_size_bytes": "Max bytes",
                    "ph_date_from": "From YYYY-MM-DD",
                    "ph_date_to": "To YYYY-MM-DD",
                    "ctx_safelist_exact_path": "Safelist this path",
                    "ctx_ignore_exact_path": "Ignore this path",
                    "ctx_ignore_path_glob": "Ignore path glob...",
                    "ctx_safelist_content_hash": "Safelist same content hash",
                    "ctx_ignore_content_hash": "Ignore same content hash",
                    "ctx_path_glob_prompt": "Glob pattern:",
                },
                "ko": {
                    "app_title": "PyDuplicate Finder Pro",
                    "scan_start": "스캔 시작",
                    ...
                    "btn_save_operation_plan": "계획 저장",
                    "btn_load_operation_plan": "계획 불러오기",
                    ...
                    "err_similar_image_dependency": "유사 이미지 스캔에는 imagehash와 Pillow가 필요합니다 (pip install imagehash Pillow)",
                    ...
                    "settings_density_label": "화면 밀도",
                    "opt_density_comfortable": "여유 있게",
                    "opt_density_compact": "촘촘하게",
                    "tip_density": "버튼과 목록의 간격을 조절합니다.",
                    "settings_follow_system": "시스템 테마 따르기",
                    "msg_title_notice": "알림",
                    ...
                    "chk_similar_document": "유사 문서 찾기 (SimHash)",
                    "chk_name_only": "파일명만 비교 (내용 무시)",
                    "chk_apply_exemptions": "세이프리스트 / 제외 규칙 적용",
                    "chk_post_cleanup_empty_dirs": "삭제 후 빈 폴더 정리",
                    "chk_watch_mode": "감시 모드",
                    ...
                    "msg_operation_plan_saved": "작업 계획 저장됨: {path}",
                    "msg_operation_plan_loaded": "계획 불러옴: {loaded}개 선택, {skipped}개 제외",
                    ...
                    "msg_delete_dry_run_title": "삭제 시뮬레이션 (Dry-run)",
                    "msg_delete_dry_run_summary": "선택: {total}개 (표시: {visible}개)\n예상 절감 용량: {size}",
                    "msg_delete_dry_run_group_line": "{idx}. {count}개 선택 • {size} • {name}",
                    "msg_delete_dry_run_more": "... 외 {count}개 그룹",
                    "msg_risk_summary": "위험도 그룹: 높음 {high} / 중간 {medium} / 낮음 {low}",
                    ...
                    "msg_insights_page_hint": "스캔 추이, 절감 용량, 실패율, 예약 실행 이력을 한눈에 봅니다.",
                    ...
                    "lbl_document_similarity_threshold": "문서 유사도 임계값:",
                    "lbl_selection_policy": "선택 정책:",
                    "lbl_compare_mode": "비교 모드:",
                    "tip_similar_image": "리사이즈되거나 재압축된 이미지도 시각적으로 유사하면 찾습니다",
                    "tip_similar_document": "SimHash를 사용해 텍스트/PDF 유사 문서를 그룹화합니다",
                    "tip_same_name": "내용과 파일명이 모두 같은 경우만 비교합니다",
                    "tip_name_only": "내용은 무시하고 파일명만 비교합니다",
                    "tip_use_trash": "파일이 시스템 휴지통으로 이동됩니다. 취소할 수 없습니다!",
                    "tip_apply_exemptions": "무시 경로를 스캔에서 제외하고 세이프리스트 파일은 자동 선택에서 보존합니다",
                    "tip_post_cleanup_empty_dirs": "삭제나 하드링크 작업 후 새로 빈 폴더가 된 상위 폴더를 정리합니다",
                    "tip_watch_mode": "선택 폴더를 계속 감시하고 변경이 생기면 증분 재스캔을 예약합니다",
                    "opt_policy_smart": "스마트",
                    "opt_policy_oldest": "가장 오래된 파일 보존",
                    "opt_policy_newest": "가장 최신 파일 보존",
                    "opt_policy_path_shortest": "경로가 가장 짧은 파일 보존",
                    "opt_policy_extension_priority": "확장자 우선",
                    "opt_policy_primary_keep": "기본 컬렉션 우선",
                    "opt_compare_none": "일반 스캔",
                    "opt_compare_collections": "컬렉션 비교",
                    ...
                    "hdr_filters_strategy": "스캔 전략",
                    "msg_scan_stage": "단계: {stage}",
                    "lbl_baseline_session": "기준 세션:",
                    "msg_incremental_no_baseline": "호환되는 완료 세션이 없어 증분 모드를 끕니다.",
                    "msg_incremental_delta": "증분 변화: +{added} 신규, {changed} 변경, -{missing} 누락",
                    ...
                    "badge_similar_document": "유사 문서",
                    "badge_byte_compare": "바이트 비교",
                    "badge_folder_dup": "폴더 중복",
                    "badge_risk_low": "위험 낮음",
                    "badge_risk_medium": "위험 중간",
                    "badge_risk_high": "위험 높음",
                    "badge_missing": "누락",
                    "badge_missing_count": "누락: {count}",
                    "label_keep": "보존: {name}",
                    "label_reclaim": "회수: {size}",
                    "label_similar_group": "유사 #{id}",
                    "label_similar_document_group": "유사 문서 #{id}",
                    ...
                    "col_created": "생성 시간",
                    "col_status": "상태",
                    "tool_exemptions_title": "세이프리스트 / 제외",
                    "tool_exemptions_desc": "스캔 예외 규칙을 관리합니다. 제외 경로는 건너뛰고, 세이프리스트 파일은 자동 선택에서 보존합니다.",
                    ...
                    "col_groups": "그룹",
                    "col_files": "파일",
                    "col_missing_folders": "누락 폴더",
                    "col_export_failed": "내보내기 실패",
                    "col_watch_events": "감시 이벤트",
                    "col_job_name": "작업명",
                    "col_next_run": "다음 실행",
                    "col_delta": "변화",
                    ...
                    "btn_retry_failed": "실패 항목 재시도",
                    "msg_retry_unavailable": "이 작업은 재시도 데이터를 찾을 수 없습니다.",
                    ...
                    "op_undo_done": "되돌리기 완료: {ok}개 복구",
                    "op_undo_partial": "되돌리기 부분 완료: {ok}개 복구 (실패 {failed})",
                    "op_redo_done": "다시 실행 완료: {ok}개 삭제",
                    "op_redo_partial": "다시 실행 부분 완료: {ok}개 삭제 (실패 {failed})",
                    "op_trash_move_failed": "파일을 휴지통으로 이동하지 못했습니다",
                    "op_trash_move_partial": "{ok}/{total}개 휴지통 이동 (실패 {failed})",
                    "op_trash_move_done": "{ok}개 휴지통 이동",
                    "op_insufficient_space": "디스크 공간 부족: 필요 {required:.1f}MB, 사용 가능 {available:.1f}MB",
                    "op_delete_partial": "{ok}/{total}개 삭제 (실패 {failed})",
                    "op_delete_done": "{ok}개 삭제 완료",
                    "op_no_files_deleted": "삭제된 파일이 없습니다",
                    "qm_item_not_found": "항목을 찾을 수 없습니다",
                    "qm_item_not_quarantined": "격리 상태의 항목이 아닙니다",
                    "qm_quarantine_file_missing": "격리 파일이 없습니다",
                    "qm_restored": "복구됨",
                    "qm_purged": "영구삭제됨",
                    ...
                    "ctx_review_keep": "보존 검토 완료로 표시",
                    "ctx_review_delete_later": "나중에 삭제로 표시",
                    "ctx_review_clear": "검토 표시 지우기",
                    "ctx_group_review_keep": "그룹 전체를 보존 검토 완료로 표시",
                    "ctx_group_review_delete_later": "그룹 전체를 나중에 삭제로 표시",
                    "ctx_group_review_clear": "그룹 검토 표시 지우기",
                    ...
                    # Scheduler settings
                    "settings_schedule_title": "예약 스캔",
                    "settings_schedule_enabled": "예약 스캔 사용",
                    "settings_schedule_frequency": "주기:",
                    "settings_schedule_time": "시간 (HH:MM):",
                    "settings_schedule_weekday": "요일:",
                    "settings_schedule_output": "출력 폴더:",
                    "settings_schedule_job_name": "작업 이름:",
                    "settings_schedule_export_json": "JSON 내보내기",
                    "settings_schedule_export_csv": "CSV 내보내기",
                    "settings_schedule_runs": "최근 실행 내역",
                    "ph_schedule_job_name": "예: nightly_photos",
                    "btn_schedule_new": "새 작업",
                    "btn_schedule_run_now": "지금 실행",

                    "btn_session_compare": "세션 비교",
                    "btn_select_in_results": "결과에서 선택",
                    "opt_delta_all": "전체 변화",
                    "opt_delta_new": "신규",
                    "opt_delta_changed": "변경",
                    "opt_delta_revalidated": "재검증",
                    "dlg_session_compare_title": "세션 비교",
                    "msg_session_compare_summary": "현재 세션 #{current} / 기준 세션 #{baseline}\n신규: {new} • 변경: {changed} • 재검증: {revalidated}",
                    "msg_session_compare_empty": "이 결과에는 baseline delta 정보가 없습니다.",

                    "insight_scans_title": "스캔",
                    "insight_scans_hint": "완료된 스캔 수 / 전체 기록 세션 수",
                    "insight_savings_title": "절감 용량",
                    "insight_savings_hint": "파일 작업으로 절감한 예상 용량",
                    "insight_fail_rate_title": "실패율",
                    "insight_fail_rate_hint": "최근 20회 기준 partial/failed 비율",
                    "insight_quarantine_title": "격리함",
                    "insight_quarantine_hint": "Undo 보관 중인 항목 수와 총 크기",
                    "insight_sessions_title": "최근 세션",
                    "insight_jobs_title": "예약 실행 이력",

                    "msg_empty_cleanup_done": "새로 비게 된 폴더 {count}개를 정리했습니다.",
                    "msg_watch_armed": "감시 모드를 시작했습니다.",
                    "msg_watch_armed_polling": "감시 모드를 시작했습니다. (폴링 대체 모드)",
                    "msg_watch_pending_rerun": "파일 시스템 변경을 감지했습니다. 현재 스캔이 끝나면 재스캔합니다.",
                    ...
                    "ex_kind_exact_path": "정확한 경로",
                    "ex_kind_path_glob": "경로 글롭",
                    "ex_kind_content_hash": "콘텐츠 해시",
                    "ex_action_safelist": "세이프리스트",
                    "ex_action_ignore": "제외",
                    "ph_exemption_value": "경로, 글롭, BLAKE2b 해시...",
                    "ph_exemption_note": "메모...",
                    "ph_exemption_search": "규칙 검색...",
                    "opt_status_all": "전체 상태",
                    "opt_status_quarantined": "격리됨",
                    "opt_status_restored": "복구됨",
                    "opt_status_purged": "영구삭제됨",
                    "ph_min_size_bytes": "최소 bytes",
                    "ph_max_size_bytes": "최대 bytes",
                    "ph_date_from": "시작 YYYY-MM-DD",
                    "ph_date_to": "종료 YYYY-MM-DD",
                    "ctx_safelist_exact_path": "이 경로 세이프리스트",
                    "ctx_ignore_exact_path": "이 경로 제외",
                    "ctx_ignore_path_glob": "경로 글롭 제외...",
                    "ctx_safelist_content_hash": "같은 콘텐츠 해시 세이프리스트",
                    "ctx_ignore_content_hash": "같은 콘텐츠 해시 제외",
                    "ctx_path_glob_prompt": "글롭 패턴:",
                }
            }
